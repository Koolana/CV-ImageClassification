...
График зависимости функции потерь от номера эпохи для тренировочной и тестовой выборки:
...
График зависимости точности классификации от номера эпохи для тренировочной и тестовой выборки:
